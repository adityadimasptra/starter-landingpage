    ...
    <>
      ...
      <div>
        <div className="flex flex-col items-center my-2 py-14">
          <h1 className="lg:text-5xl text-gray-500 md:text-4xl">Contact Us</h1>
        ...
        <div className="my-8 grid mx-10 lg:mx-48 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1">
          ...
          <div className="flex flex-col justify-center mx-20 lg:items-start md:items-center">
            ...
            <div className="my-4 flex">
              <a className="blink-1 mx-2" target="_blank" href="https://wa.me/6281553176532" rel="noopener noreferrer">
                +62 815-5317-6532
              </a> 
              / 
              <a className="blink-1 mx-2" target="_blank" href="https://wa.me/6281332693518" rel="noopener noreferrer">
                +62 813-3269-3518
              </a> 
            </div>
            ...
            <hr className="w-60"/>
            <div className="my-4 flex">
              <a className="mx-2 blink-1" target="_blank" href="https://wa.me/6281332693518" rel="noopener noreferrer">
                example1@gmail.com
              </a> 
              /
              <a className="mx-2 blink-1" target="_blank" href="https://wa.me/6281332693518" rel="noopener noreferrer">
